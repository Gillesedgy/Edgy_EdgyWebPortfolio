    ...
    <div className="About">
      <div className="About__passionAndInterests section">
        ...
        <p>
          ...
          development. Whether it's coding or constructing hardware, I thrive on
          creating solutions that are both efficient and elegant.
        </p>
        <p>
      ...
      <div className="About__philosophy section">
        ...
        <p>
          ...
          breaking down complex problems into manageable tasks, always striving
          for a balance between functionality and aesthetics. Continuous
          learning and adhering to industry best practices are at the core of my
          professional growth.
        </p>
      </div>
      ...
      <div className="About__freetime section">
        ...
        <p>
          ...
          Additionally, as a proud dog owner, you'll often find me on walks with
          my furry friend, appreciating the beauty of nature and the simple joys
          of life.
        </p>
      </div>
